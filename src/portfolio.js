...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1KMttYAiNWN_9v0zPys5Syti95shQgrKD/view?usp=sharing", // Set to empty to hide the button
  ...
  projects: [
    {
      ...
      projectDesc: "I helped develop the company.",
      footerLink: [
        {
          name: "Visit Website",
